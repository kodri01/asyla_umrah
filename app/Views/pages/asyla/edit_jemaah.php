        ...
        <form action="/asyla/update_jemaah/<?= $profile['id'] ?>" method="post" enctype="multipart/form-data">
            <div class="card px-3 py-2">
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="" class="">Nama Jemaah</label>
                            <input type="text" name="nama_suami" class="form-control"
                                value="<?= $profile['nama_suami'] ?>" placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Nama Suami/Istri</label>
                            <input type="text" name="nama_istri" class="form-control"
                                value="<?= $profile['nama_istri'] ?>" placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <label for="" class="">Tempat Lahir</label>
                            <input type="text" name="tempat_lahir" value="<?= $profile['tempat_lahir_suami'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Tanggal Lahir</label>
                            <input type="date" name="tgl_lahir" class="form-control"
                                value="<?= $profile['lahir_suami'] ?>" placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="pendidikan" class="form-control"
                                value="<?= $profile['pend_suami'] ?>" placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Pekerjaan</label>
                            <input type="text" name="pekerjaan" value="<?= $profile['pekerja_suami'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="desa" value="<?= $profile['desa'] ?>" class="form-control"
                                placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kecamatan" value="<?= $profile['kecamatan'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Kabupaten</label>
                            <input type="text" name="kabupaten" value="<?= $profile['kabupaten'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="provinsi" class="form-control" value="<?= $profile['provinsi'] ?>"
                                placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Kode Pos</label>
                            <input type="text" name="kode_pos" value="<?= $profile['kode_pos'] ?>" class="form-control"
                                placeholder="" aria-label="">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="hp_jemaah" value="<?= $profile['hp_jemaah'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                        <div class="col-md-6">
                            <label for="" class="">Telepon Jemaah</label>
                            <input type="text" name="telp_jemaah" value="<?= $profile['telp_jemaah'] ?>"
                                class="form-control" placeholder="" aria-label="">
                        </div>
                    </div>
