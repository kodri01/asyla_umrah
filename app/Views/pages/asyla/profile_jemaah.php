                        ...
                        <div class="tab-pane active" id="data">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control text-capitalize" disabled name="nama" id="first_name" value="<?= $profile['nama']; ?>" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="tempat_lahir" disabled id="first_name" value="<?= $profile['tempat_lahir']; ?>" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="date" class="form-control " name="tgl_lahir" disabled id="first_name" value="<?= $profile['tgl_lahir']; ?>" title="">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" disabled class="form-control text-capitalize" name="jns_kelamin" id="first_name" value="<?= $profile['jns_kelamin']; ?>" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control text-capitalize" disabled name="usia" id="first_name" value="<?= $profile['usia'] . ' Tahun' ?>" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="alamat" disabled id="first_name" value="<?= $profile['alamat']; ?>" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <?php if ($profile['status'] == 0) : ?>
                                        <div class="card text bg-warning my-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="/asyla/edit_berkas/<?= $profile['id'] ?>" class="btn btn-info">Lengkapi</a>
                                            </div>
                                        </div>
                                    <?php else : ?>
